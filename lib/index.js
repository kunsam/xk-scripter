...
var fs = require("fs");
var createDOfromDTO_1 = require("./gele/createDOfromDTO");
...
program
    ...
    try {
        ...
        // 解决报错
        (0, loopInput_1.default)("OK", function () { return false; });
    }
    catch (e) {
...
program
    ...
    if (!fs.existsSync("java.ts")) {
        chalk_1.default.red("java.ts Not Exist!");
        return;
    }
    var file = fs.readFileSync("java.ts").toString();
    (0, createDOfromDTO_1.createDOFromDTO)(file);
